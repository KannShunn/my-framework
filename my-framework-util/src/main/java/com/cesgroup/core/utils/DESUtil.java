...
public class DESUtil {
    ...
    /** 安全密钥 */
    public static String keyData = "cesgroup";
...
/*    public static void main(String[] args) {
		...
		DESUtil.keyData = "ces_infoplat50";
		
		String jdbcUrlEncode = DESUtil.encrypt(jdbcUrl);
		System.out.println(jdbcUrlEncode);
		String jdbcUrlDecode = DESUtil.decrypt(jdbcUrlEncode);
		System.out.println(jdbcUrlDecode);
	}*/
