 ...
 * springSecurity/springSecurityIII/src/main/java/com/spring/security/jcaptcha/
 * GMailEngine.java?spec=svn447&r=447
...
public class GMailEngine extends ListImageCaptchaEngine
{
	...
	protected void buildInitialFactories()
	{
		...
		FontGenerator font = new RandomFontGenerator(fontSize, fontSize,
				new Font[] { new Font("nyala", Font.BOLD, fontSize), new Font("Bell MT", Font.PLAIN, fontSize), new Font("Credit valley", Font.BOLD, fontSize) });
