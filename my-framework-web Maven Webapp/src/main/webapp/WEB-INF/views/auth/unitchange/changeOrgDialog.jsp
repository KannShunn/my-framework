...
<%@ include file="../../../include/global.jsp"%>
	...
	<div class="leftTree">
		<cui:tree id="unitChangeOrgTree" asyncEnable="true" asyncType="post" 
		asyncUrl="${ctx}/auth/unitChange/getAllOrgTree" asyncAutoParam="id,name" onLoad="unitChangeOrgTreeOnload" checkable="true" radioType="all" chkStyle="radio" simpleDataEnable="true" >
		</cui:tree>
	</div>
<script>
	function unitChangeOrgTreeOnload(e, treeId, treeNode){
		//改变组织树
		var orgTree = $("#"+treeId);
		//根节点不带选择框
